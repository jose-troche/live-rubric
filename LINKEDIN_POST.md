...
A regular LLM is an essayist. You ask a question, it writes a paragraph. But your code can't act on a paragraph — it needs a number or a label — so you ask for JSON instead. Trouble is, that JSON is still just text, generated one character at a time. A missing brace, an invented field, a cheerful "Sure! Here's the JSON:" glued to the front. So your software parses it and prays.
...
Clarity. Specificity. Structure. Tone. Audience. Risk. Does it name an owner? Is it jargon-heavy?
